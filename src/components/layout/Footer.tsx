...
const Footer = () => {
  return (
    <footer className="bg-brand-darker border-t border-white/10 pt-16 pb-8 text-white relative overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 w-64 h-64 bg-[#8CC63F]/5 blur-3xl rounded-full translate-x-1/2 translate-y-1/2" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 md:col-span-2 space-y-6">
            <Link to="/" className="inline-block mb-4">
              <span className="text-2xl font-black tracking-tighter uppercase">
                NINNA<span className="text-[#8CC63F] ml-1">HUB</span>
              </span>
            </Link>
            ...
            <div className="flex space-x-6">
              {[Instagram, Linkedin, Twitter].map((Icon, i) => (
                <a key={i} href="#" className="text-white/40 hover:text-[#8CC63F] transition-colors">
            ...
            <div className="mt-6">
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 border border-white/20 hover:border-[#8CC63F]/60 hover:bg-[#8CC63F]/10 text-white/60 hover:text-[#8CC63F] rounded-xl text-[10px] font-black uppercase tracking-widest transition-all"
              >
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-[#8CC63F] font-black uppercase text-[10px] tracking-widest mb-8">Navegação</h3>
          ...
          {/* Contact */}
          <div>
            <h3 className="text-[#8CC63F] font-black uppercase text-[10px] tracking-widest mb-8">Contato</h3>
