    ...
    <footer className="bg-brand-darker border-t border-white/10 pt-16 pb-8 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 md:col-span-2 space-y-6">
            <Link to="/" className="inline-block mb-4">
              <span className="text-2xl font-black tracking-tighter uppercase">
                NINNA<span className="text-brand-teal ml-1">HUB</span>
              </span>
            </Link>
            ...
            <div className="flex space-x-6">
              {[Instagram, Linkedin, Twitter].map((Icon, i) => (
                <a key={i} href="#" className="text-white/40 hover:text-brand-teal transition-colors">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-brand-teal font-black uppercase text-[10px] tracking-widest mb-8">Navegação</h3>
          ...
          {/* Contact */}
          <div>
            <h3 className="text-brand-teal font-black uppercase text-[10px] tracking-widest mb-8">Contato</h3>
            <ul className="space-y-6">
              <li className="flex items-center space-x-3 text-white/60">
                <Mail className="w-5 h-5 text-brand-teal" />
                <span className="text-sm font-medium">marildo.martins@ninnahub.com.br</span>
              </li>
              <li className="flex items-center space-x-3 text-white/60">
                <Phone className="w-5 h-5 text-brand-teal" />
                <span className="text-sm font-black italic">(85) 9 8984-4779</span>
              </li>
