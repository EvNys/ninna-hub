...
const Eventos = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(
        "Ocorreu um erro ao registrar sua solicitação. Tente novamente.",
      );
    } finally {
      setSubmitting(false);
    }
  ...
  const parceirosEventos = [
    ...
    { name: "Extrafarma", logo: "/Imagens_NINNA/Extrafarma.png" },
    {
      ...
      logo: "/Imagens_NINNA/GrupoEdsonQueiroz.png",
    },
  ...
  return (
    <div className=" bg-[#fafafa] min-h-screen">
      <meta
        name="description"
        content="Conheça o Ecossistema NINNA e veja como as startups, empresas e nossa equipe interajem entre si"
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-500 max-w-3xl mx-auto leading-relaxed border-t border-gray-100 pt-8 mt-8 font-medium">
              O NINNA Hub é o ponto de encontro de startups, corporações de
              vanguarda e mentes brilhantes. Projetamos marcas e catalisamos
              conexões de alto impacto com eventos que trazem transformação real
              ao mercado.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-5 space-y-6">
              <span className="text-[10px] font-black text-brand-teal uppercase tracking-[0.4em]">
                Palco das Conexões
              </span>
              <h2 className="text-4xl md:text-5xl font-black text-white uppercase tracking-wide  leading-none">
                ECOSSISTEMAS QUE <span className="gradient-text">GERAM</span>{" "}
                IMPACTO
              </h2>
              ...
              <div className="pt-6 font-inter">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <span className="font-bold text-white/85 text-sm">
                    Geração espontânea de networking qualificado
                  </span>
                </div>
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-6 h-6 rounded-full bg-brand-teal/10 flex items-center justify-center text-brand-teal">
                  ...
                  <span className="font-bold text-white/85 text-sm">
                    Aproximação direta com ideias disruptivas do ecossistema
                  </span>
                </div>
                <div className="flex items-center gap-4">
                  ...
                  <span className="font-bold text-white/85 text-sm">
                    Posicionamento como embaixador de inovação regional
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="p-8 bg-white/[0.03] backdrop-blur-md rounded-[30px] border border-white/10 space-y-4">
                ...
                <p className="text-white/50 text-sm font-barlow leading-relaxed">
                  Espaço favorável para compartilhar descobertas, cases
                  corporativos e estratégias práticas de mercado.
                </p>
              </div>
              ...
              <div className="p-8 bg-white/[0.03] backdrop-blur-md rounded-[30px] border border-white/10 space-y-4 sm:translate-y-6">
                ...
                <p className="text-white/50 text-sm font-barlow leading-relaxed">
                  Proximidade direta com mais de 100 startups em tecnologia e
                  dezenas de corporações parceiras de inovação aberta.
                </p>
              </div>
              ...
              <div className="p-8 bg-white/[0.03] backdrop-blur-md rounded-[30px] border border-white/10 space-y-4">
                ...
                <p className="text-white/50 text-sm font-barlow leading-relaxed">
                  Um ambiente preparado para grandes conexões: equipamentos
                  audiovisuais de ponta, internet dedicada corporativa de alto
                  desempenho e equipe de suporte operacional local.
                </p>
              </div>
              ...
              <div className="p-8 bg-white/[0.03] backdrop-blur-md rounded-[30px] border border-white/10 space-y-4 sm:translate-y-6">
                ...
                <p className="text-white/50 text-sm font-barlow leading-relaxed">
                  Ambiente acolhedor e dinâmico, focado na cultura ágil de
                  feedback, cocriação e colaboração.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            ...
            >
              ...
              <div className="space-y-4 relative z-10">
                ...
                <div className="space-y-2">
                  ...
                  <h3 className="text-3xl font-black text-white uppercase tracking-wide  leading-none">
                    Conhecer Oportunidades
                  </h3>
                  <p className="text-white/60 font-barlow text-sm sm:text-base leading-relaxed">
                    Aproximação direta com o mercado inovador cearense. Explore
                    projetos abertos, vagas em tecnologia, desafios de inovação
                    corporativa e programas dedicados a acelerar marcas.
                  </p>
                </div>
              </div>
              <Link
            ...
            >
              ...
              >
                <Calendar className="w-4 h-4 text-brand-teal shrink-0 animate-pulse" />{" "}
                Ver Agenda de Eventos
              </Link>
            </motion.div>
          </div>
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-24">
            <span className="text-[10px] font-black text-brand-teal uppercase tracking-[0.4em] mb-4 block">
              Nossos Selos Oficiais
            </span>
            <h3 className="text-4xl md:text-5xl font-black text-gray-900 uppercase tracking-wide ">
              EVENTOS PROPRIETÁRIOS DO{" "}
              <span className="gradient-text">NINNA</span>
            </h3>
            <p className="text-gray-500 max-w-xl mx-auto font-medium mt-4">
              Formatos exclusivos criados e promovidos pelo NINNA para catalisar
              conexões valiosas, desenvolver capacitações e aproximar marcas
          ...
          <div className="space-y-32">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
              <div className="order-2 lg:order-1 lg:col-span-6 space-y-6">
                ...
                <p className="text-gray-500 font-medium text-base md:text-lg leading-relaxed">
                  O ponto de encontro definitivo entre grandes corporações e as
                  melhores startups em ascensão. Com sessões focadas de pitches
                  e dinâmicas de conexão assistidas, apresentamos as soluções
                  mais disruptivas do mercado estadual aos decisores, diretores
                  e patrocinadores estratégicos.
                </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
              ...
              <div className="order-2 lg:col-span-6 space-y-6">
                ...
                <p className="text-gray-500 font-medium text-base md:text-lg leading-relaxed">
                  O happy hour indispensável pós-trabalho que une a melhor
                  comunidade de negócios cearense. Reunimos fundadores,
                  gestores, conselheiros e investidores em bate-papos
                  acolhedores e descontraídos para trocar aprendizados, debater
                  novas teses de mercado e celebrar novas parcerias comerciais
                  sustentáveis.
                </p>
                <ul className="space-y-3 pt-2">
                  <li className="flex items-center gap-3 text-sm text-gray-600 font-inter">
                  ...
                  <li className="flex items-center gap-3 text-sm text-gray-600 font-inter">
                    ...
                    <span>
                      Partilha espontânea de insights e lições práticas
                    </span>
                  </li>
                  <li className="flex items-center gap-3 text-sm text-gray-600 font-inter">
                    <div className="w-5 h-5 rounded-full bg-brand-green/10 flex items-center justify-center text-brand-green shrink-0">
                    ...
                    <span>
                      Ambiente festivo propício para conectar e relaxar
                    </span>
                  </li>
                  <a
              ...
              <div className="order-2 lg:order-1 lg:col-span-6 space-y-6">
                ...
                <ul className="space-y-3 pt-2">
                  <li className="flex items-center gap-3 text-sm text-gray-600 font-inter">
                    ...
                    <span>
                      Encontros intensificados em grupos pequenos e focados
                    </span>
                  </li>
                  <li className="flex items-center gap-3 text-sm text-gray-600 font-inter">
                    <div className="w-5 h-5 rounded-full bg-brand-teal/10 flex items-center justify-center text-brand-teal shrink-0">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
              ...
              <div className="order-2 lg:col-span-6 space-y-6">
                ...
                <p className="text-gray-500 font-medium text-base md:text-lg leading-relaxed">
                  Painéis e encontros institucionais estratégicos voltados para
                  o fomento tecnológico regional e diálogo com o poder público.
                  O NINNA atua como embaixador integrando a academia, indústrias
                  setoriais de destaque e órgãos fomentadores para cocriar leis,
                  infraestrutura, capitais de risco e caminhos de inovação
                  produtiva regional.
                </p>
                <ul className="space-y-3 pt-2">
                  <li className="flex items-center gap-3 text-sm text-gray-600 font-inter">
                    ...
                    <span>
                      Integração entre Estado, Universidades e Empresas
                    </span>
                  </li>
                  <li className="flex items-center gap-3 text-sm text-gray-600 font-inter">
                    <div className="w-5 h-5 rounded-full bg-brand-green/10 flex items-center justify-center text-brand-green shrink-0">
                  ...
                  <li className="flex items-center gap-3 text-sm text-gray-600 font-inter">
                    ...
                    <span>
                      Lançamentos institucionais de alta repercussão cearense
                    </span>
                  </li>
                </ul>
              </div>
      ...
      <section className="py-24 bg-gray-950 text-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-[10px] font-black text-brand-teal uppercase tracking-[0.4em] mb-4">
              Estrutura de Alto Nível
            </h2>
            <h3 className="text-4xl md:text-5xl font-black text-white uppercase tracking-wide ">
              NOSSOS <span className="gradient-text">ESPAÇOS</span>
            </h3>
            <p className="text-white/60 max-w-xl mx-auto font-barlow mt-4">
              Equipados com o melhor em tecnologia para garantir que seu
              treinamento, convenção ou pitch day seja impecável.
            </p>
          </div>
              ...
              <div className="p-8 flex-grow flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-white/60 font-barlow leading-relaxed mb-6">
                    O palco principal de nossos maiores anúncios. O Auditório do
                    NINNA é ideal para grandes palestras, eventos híbridos,
                    lançamentos corporativos de novos produtos, conferências de
                    investidores e painéis de lideranças nacionais.
                  </p>
            ...
            >
              ...
              <div className="p-8 flex-grow flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-white/60 font-barlow leading-relaxed mb-6">
                    Um ambiente sofisticado e reservado, projetado para
                    encontros bilaterais, reuniões de conselho de alta
                    liderança, comitês executivos e apresentações exclusivas
                    para investidores de alta notoriedade.
                  </p>
              ...
              <div className="p-8 flex-grow flex flex-col justify-between">
                <div>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-[10px] font-black text-brand-teal uppercase tracking-widest bg-brand-teal/5 px-4 py-2 rounded-xl border border-brand-teal/10">
                      Capacidade: 8 a 10 Pessoas
                    </span>
                  </div>
                  <p className="text-white/60 font-barlow leading-relaxed mb-6">
                    O espaço perfeito para desbloquear a criatividade e
                    impulsionar projetos ágeis. Ideal para sessões de cocriação,
                    workshops focados em inovação rápida, design thinking e
                    sprints acelerados de produto.
                  </p>
      ...
      <section className="py-20 bg-[#fafafa]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h5 className="text-xl font-black text-gray-900 uppercase tracking-wide mt-2">
              EMPRESAS QUE REALIZAM EVENTOS NO NINNA
            </h5>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-8">
              ...
              <h2 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-wide uppercase  leading-[0.95]">
                QUERO REALIZAR MEU <span className="gradient-text">EVENTO</span>{" "}
                NO NINNA
              </h2>
              ...
              <p className="text-gray-400 font-medium text-lg leading-relaxed max-w-2xl">
                Preencha os dados e configure o seu evento com o suporte direto
                das nossas lideranças tecnológicas. Oferecemos opções
                personalizadas de espaços, equipamentos de ponta e curadoria
                dedicada de público corporativo para garantir o sucesso total da
                sua iniciativa.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-extrabold uppercase text-xs tracking-wider text-white">
                      CURADORIA CORPORATIVA
                    </h4>
                    <p className="text-xs text-gray-500 font-medium mt-1">
                      Conexão qualificada com startups, investidores e
                      decisores.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 font-medium mt-1">
                      Sonorização array, displays touch magnéticos e projeção a
                      laser.
                    </p>
                  </div>
                </div>
            ...
            <div className="lg:col-span-5">
              ...
              >
                <div className="space-y-4 mb-8">
                  <span className="text-[9px] font-black text-brand-teal uppercase tracking-widest block">
                    PROPOSTA COMERCIAL
                  </span>
                  ...
                  <p className="text-sm text-gray-400 font-medium leading-relaxed">
                    Nossa equipe comercial desenhará um formato sob medida para
                    o seu orçamento e objetivos estratégicos de marca.
                  </p>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
              <div className="lg:col-span-7 space-y-6">
                ...
                <p className="text-gray-500 font-medium text-lg leading-relaxed">
                  Ao patrocinar nossos eventos no NINNA Hub, sua marca ganha
                  destaque em frente a um ecossistema seletivo de líderes,
                  diretores de inovação e startups de alta tração tecnológica.
                  Oferecemos pacotes integrados que combinam exposição visual,
                  inserções de palco, keynote slots e geração assistida de leads
                  de inovação.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
                  <div className="p-6 bg-white border border-gray-100 rounded-2xl">
                    <h5 className="font-black uppercase text-sm text-gray-900  mb-2">
                      Visibilidade Exclusiva
                    </h5>
                    <p className="text-gray-500 text-xs font-barlow">
                      Exposição em banners físicos, mídias digitais e painéis de
                      palestras.
                    </p>
                  </div>
                  <div className="p-6 bg-white border border-gray-100 rounded-2xl">
                    ...
                    <p className="text-gray-500 text-xs font-barlow">
                      Slots dedicados para pitch e lista exclusiva de leads
                      cadastrados.
                    </p>
                  </div>
                </div>
              ...
              <div className="lg:col-span-5 text-center lg:text-left bg-white p-10 rounded-[35px] border border-gray-100 shadow-xl space-y-8">
                <div className="space-y-2">
                  ...
                  <h4 className="text-xl font-black text-gray-900 uppercase tracking-wide ">
                    AGENDA COMUNIDADE CO-CREATE
                  </h4>
                  <p className="text-sm text-gray-500 font-medium leading-relaxed">
                    Ajude-nos a apoiar o desenvolvimento do ecossistema e
                    posicione a sua marca no topo da pirâmide de inovação
                    regional cearense.
                  </p>
                </div>
              ...
              {submitSuccess ? (
                <div className="text-center py-12 space-y-6">
                  ...
                  <p className="text-gray-500 font-medium max-w-sm mx-auto">
                    Nossa equipe de curadoria do ecossistema entrará em contato
                    comercial dentro de até 24 horas úteis para alinhar os
                ...
                <div className="space-y-6">
                  <span className="text-[10px] font-black text-brand-teal uppercase tracking-[0.3em] block">
                  ...
                  <form
                    ...
                    className="space-y-3 sm:space-y-4 pt-4 text-left"
                  >
                    ...
                    <div className="space-y-1">
                      <label className="text-[9px] font-black text-gray-400 uppercase tracking-widest">
                        Categoria de Patrocínio Desejada
                      </label>
                      <select
                        name="tipoPatrocinio"
                        ...
                        className="w-full bg-[#fafafa] border border-gray-100 rounded-2xl px-4 py-3 sm:px-6 sm:py-4 text-gray-900 focus:outline-none focus:border-brand-teal text-sm shadow-sm"
                      >
                        <option value="Patrocínio de Agenda Anual">
                          Parceiro Estratégico Anual
                        </option>
                        <option value="Cotas para Evento Exclusivo">
                          Cota de Apoio a Evento Exclusivo
                        </option>
                        <option value="Apoio de Happy Hour / Coffee">
                          Apoiador Happy Hour & Networking
                        </option>
                      </select>
                    </div>
                    ...
                    <div className="space-y-1">
                      <label className="text-[9px] font-black text-gray-400 uppercase tracking-widest">
                        Ideia Preliminar ou Observações
                      </label>
                      <textarea
                        name="mensagem"
