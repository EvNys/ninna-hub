...
const Cases = () => {
  ...
  return (
    <div className="pb-32 bg-[#fafafa] min-h-screen">
      <meta
        name="description"
        content="Explore histórias, cases e exits de sucesso de empresas que colaboraram com startups no ecossistema NINNA."
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
            ...
            <p className="text-xl text-gray-500 max-w-md font-medium leading-relaxed ">
              Resultados reais gerados através da conexão entre grandes empresas
              e startups no ecossistema NINNA.
            </p>
          </div>
        </div>
      </section>
          ...
          {loading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {Array(6)
                ...
                .map((_, i) => (
                  <div
                    key={i}
                    className="bg-white rounded-[40px] h-96 animate-pulse border border-gray-100 shadow-xl"
                  />
                ))}
            </div>
          ) : cases.length === 0 ? (
            <div className="text-center py-32 bg-white rounded-[60px] border border-gray-100 shadow-2xl">
              ...
              <p className="text-gray-500 mt-2 font-medium">
                Estamos preparando grandes novidades para você.
              </p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
