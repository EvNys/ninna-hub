        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {loading ? (
            ...
            <div className="text-center py-32 bg-white rounded-[40px] border border-gray-100 p-20 shadow-xl">
              ...
              <h3 className="text-2xl font-black text-gray-400 uppercase tracking-tight italic">Nenhuma oportunidade aberta</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {oportunidades.map((item, index) => (
                ...
                >
                  ...
                  <h3 className="text-3xl md:text-4xl font-black mb-6 group-hover:text-brand-teal transition-colors text-gray-900 uppercase tracking-tighter italic leading-[0.9]">{item.titulo}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white p-12 md:p-20 relative overflow-hidden border border-gray-100 rounded-[60px] shadow-2xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-8 uppercase tracking-tighter italic">SUA EMPRESA QUER <br /><span className="text-brand-teal">LANÇAR UM EDITAL?</span></h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-8 bg-gray-50 border border-gray-100 rounded-3xl">
                  <div className="text-brand-teal font-black text-4xl mb-2 italic tracking-tighter">+20</div>
                  <div className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Editais Lançados</div>
                </div>
                <div className="p-8 bg-gray-50 border border-gray-100 rounded-3xl">
                  <div className="text-brand-teal font-black text-4xl mb-2 italic tracking-tighter">R$5M</div>
