            ...
            <aside className="lg:w-72 shrink-0 space-y-10">
              ...
              {(selectedCategory !== 'all' || selectedMaturity !== 'all' || selectedBusinessType !== 'all' || searchTerm !== '') && (
                <button 
                  ...
                  className="w-full py-4 border border-dashed border-gray-200 rounded-xl text-[10px] font-black uppercase tracking-widest text-gray-400 hover:text-red-500 hover:border-red-200 transition-all flex items-center justify-center gap-2"
                >
