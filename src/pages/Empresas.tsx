...
const Empresas = () => {
  ...
  const services = [
    {
      ...
      description:
        "Conectamos os desafios da sua empresa às melhores soluções do ecossistema de startups.",
      icon: <Zap className="w-8 h-8 text-brand-orange" />,
    },
    {
      title: "Corporate Venture",
      description:
        "Apoiamos a estruturação de teses de investimento e aproximação com startups estratégicas.",
      icon: <BarChart3 className="w-8 h-8 text-brand-purple" />,
    },
    {
      title: "Cultura de Inovação",
      description:
        "Programas de intraempreendedorismo e workshops para transformar o mindset do seu time.",
      icon: <Users className="w-8 h-8 text-brand-green" />,
    },
    {
      title: "Conexões Estratégicas",
      description:
        "Acesso privilegiado a uma rede de atores, especialistas e outras grandes corporações.",
  ...
  return (
    <div className="pb-32 bg-[#fafafa]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-600 mb-10 leading-relaxed max-w-xl font-medium">
                Ajudamos grandes empresas a navegar na complexidade da inovação,
                gerando eficiência, novos modelos de negócio e impacto real.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-6xl font-black text-gray-900 mb-6 uppercase tracking-wide">
              ...
              <span className="text-[#00c9a7] underline decoration-gray-200">
                NINNA
              </span>
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto font-medium">
              Conheça as corporações que acreditam e investem no NINNA Hub como
              motor de transformação e inovação.
            </p>
          </div>
            ...
            {loading ? (
              Array(10)
                ...
                .map((_, i) => (
                  <div
                    key={i}
                    className="h-40 rounded-3xl bg-gray-50 animate-pulse border border-gray-100"
                  />
                ))
            ) : partners.length === 0 ? (
      ...
      {/* Services Grid */}
      <section
        className="py-32 bg-[#050911] relative overflow-hidden text-white"
        id="como-apoiamos-jornada-section"
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
          <div className="text-center mb-24">
            ...
            <h2 className="text-5xl md:text-7xl font-black text-white mb-6 uppercase tracking-wide leading-none">
              Como apoiamos sua <br />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {services.map((service, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`p-6 rounded-3xl shrink-0 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 shadow-md ${iconBgColors}`}
                  >
                    {service.icon}
                  </div>
                  <div>
                    <h3 className="text-2xl font-black text-white mb-4 uppercase tracking-wide group-hover:text-[#00c9a7] transition-colors">
                      {service.title}
                    </h3>
                    ...
                    <button className="text-xs font-black text-[#00c9a7] flex items-center hover:translate-x-2 transition-transform uppercase tracking-[0.2em] cursor-pointer">
                      Saiba mais{" "}
                      <ArrowRight className="ml-2 w-4 h-4 text-[#b5ff53]" />
                    </button>
                  </div>
                </motion.div>
              );
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white p-12 md:p-24 rounded-[60px] border border-gray-100 shadow-2xl relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center relative z-10">
              <div>
                <h3 className="text-3xl md:text-5xl font-black text-gray-900 mb-4 uppercase tracking-wide leading-[0.85]">
                  Por que ser uma <br />
                  <span className="text-[#00c9a7]">Corporação?</span>
                </h3>
                <div className="space-y-10 mt-12">
                  {[
                    ...
                    <div key={i} className="flex items-start space-x-6">
                      ...
                      <div>
                        <h4 className="text-xl font-black text-gray-900 uppercase tracking-wide mb-2">
                          {item.title}
                        </h4>
              ...
              <div className="relative">
                ...
                <div className="relative bg-[#fafafa] border border-gray-200 p-10 md:p-14 rounded-[40px] shadow-inner">
                  <h3 className="text-3xl font-black text-gray-900 mb-8 uppercase tracking-wide">
                  ...
                  <form className="space-y-6">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className="w-full bg-white border border-gray-200 rounded-2xl px-6 py-4 focus:outline-none focus:border-[#00c9a7] text-gray-900"
                      />
                    </div>
                    <div className="space-y-2">
                      <label className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] ml-2">
                    ...
                    <div className="space-y-4 pt-2 mb-6">
                      <label className="flex items-center space-x-3 cursor-pointer group">
                        ...
                        <span className="text-[10px] font-black text-gray-500 uppercase tracking-widest group-hover:text-gray-900 transition-colors">
                          Desejo conectar-me com soluções tecnológicas
                        </span>
                      </label>
                    </div>
