...
import {
  EQUIPE_PADRAO,
  type MembroEquipePadrao,
} from "../data/equipe-fallback";
...
const Sobre = () => {
        ...
        if (fbMembers.length > 0) {
          ...
          fbMembers.forEach((fb) => {
            const index = merged.findIndex(
              (m) => m.nome.toLowerCase() === fb.nome.toLowerCase(),
            );
            if (index !== -1) {
  ...
  const values = [
    {
      title: "Transparência",
      description:
        "Nós começamos com transparência, porque acreditamos que a clareza e a verdade em nossas ações e decisões criam confiança entre todos os envolvidos.",
      icon: <ShieldCheck className="w-10 h-10" />,
    },
    {
      title: "Profissionalismo",
      description:
        "Reforça a seriedade, a ética e a excelência que o NINNA entrega no seu trabalho.",
      icon: <Users className="w-10 h-10" />,
    },
    {
      title: "Organização",
      description:
        "É o que transforma ideias em resultados, permitindo que nossos processos sejam consistentes e alinhados.",
      icon: <FolderOpen className="w-10 h-10" />,
    },
    {
      title: "Engajamento",
      description:
        "O coração pulsante, representando a energia coletiva e a colaboração para atingir objetivos, é o que conecta nossa equipe, parceiros e clientes. ",
      icon: <Target className="w-10 h-10" />,
    },
    {
      title: "Ousadia",
      description:
        "A coragem de experimentar e desafiar o status quo. Nos inspira a ir além do esperado.",
      icon: <Heart className="w-10 h-10" />,
    },
    {
      title: "Inquietude",
      description:
        "O espírito de constante questionamento e evolução, essencial para manter a relevância em um mercado dinâmico.",
      icon: <Rocket className="w-10 h-10" />,
    },
    {
      title: "Transformação",
      description:
        "O impacto que o NINNA busca gerar em seus parceiros, no mercado e no ecossistema de inovação é a essência do nosso propósito.",
  ...
  return (
    <div className="bg-[#fafafa] min-h-screen overflow-hidden">
      <meta
        name="description"
        content="Conheça a história, os valores do NINNA Hub e a Equipe do espaço de inovação e conexão entre startups, empresas e profissionais."
      />
      {/* Hero Section */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed border-t border-gray-200 pt-8 mt-8 font-medium">
              Conheça a trajetória do NINNA Hub, um polo de inovação que nasceu
              para transformar o futuro através da tecnologia e do
              empreendedorismo.
            </p>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <h2 className="text-5xl md:text-7xl font-black mb-10 leading-[0.9] text-white uppercase tracking-wide ">
                INOVAÇÃO COM <br />
                <span className="text-[#0ae2b1] underline decoration-white/20">
                  DNA CEARENSE
                </span>
              </h2>
              <div className="space-y-4 text-white/75 text-lg leading-relaxed font-barlow">
                <p className="border-l-2 border-[#0ae2b1] pl-8">
                  O Núcleo de Inovação e Novos Negócios Aplicados,{" "}
                  <strong>NINNA Hub</strong>, é um hub de inovação que conecta
                  empresas, startups, investidores e instituições estratégicas
                  para impulsionar a transformação dos negócios por meio da
                  inovação aberta, da tecnologia e do empreendedorismo.
                </p>
                <p className="pl-8 text-white/70">
                  Com sede em Fortaleza, atuamos como um ambiente de colaboração
                  que aproxima desafios corporativos de soluções inovadoras,
                  promovendo programas, conexões e iniciativas voltadas à
                  geração de valor, competitividade e crescimento sustentável
                  para organizações de diferentes setores.
                </p>
                <p className="pl-8 text-white/70">
                  Reconhecido como uma das principais referências em inovação do
                  Nordeste, o NINNA Hub fortalece o ecossistema regional ao
                  acelerar a adoção de novas tecnologias, fomentar a cultura de
                  inovação e criar oportunidades que geram impacto econômico e
                  social.
                </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-24 space-y-4">
            ...
            <h2 className="text-5xl md:text-7xl font-black text-gray-900 uppercase tracking-wide ">
              NOSSOS{" "}
              <span className="text-brand-teal underline decoration-gray-200">
                VALORES
              </span>
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto font-barlow text-lg">
              O que nos guia todos os dias na busca por resultados
              extraordinários e impacto real no ecossistema.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto font-medium mt-4">
              Empresas e instituições que acreditam no ecossistema NINNA, apoiam
              o desenvolvimento de novas soluções e negócios inovadores.
            </p>
          </div>
          ...
          <div className="bg-white/[0.03] backdrop-blur-md p-12 md:p-24 relative overflow-hidden border border-white/10 shadow-2xl rounded-[60px]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
              <div>
                ...
                <h2 className="text-4xl md:text-6xl font-black mb-10 text-white uppercase tracking-wide leading-none ">
                  ONDE A <br />
                  <span className="text-[#0ae2b1] underline decoration-white/20">
                    MÁGICA
                  </span>{" "}
                ...
                <p className="text-white/70 text-lg leading-relaxed mb-10 font-barlow max-w-md">
                  Nosso espaço físico é projetado para fomentar a criatividade e
                  o networking de alto impacto. Venha conhecer o futuro da
                  inovação.
                </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <h2 className="text-5xl md:text-7xl font-black mb-10 text-gray-900 uppercase tracking-wide leading-[0.9] ">
                INOVAÇÃO QUE <br />
                <span className="text-brand-teal">TRANSFORMA VIDAS</span>
              </h2>
              <p className="text-xl text-gray-500 font-medium leading-relaxed mb-12">
                O NINNA Hub acredita que a tecnologia e a inovação devem ser
                ferramentas de inclusão social e desenvolvimento regional. Nosso
                compromisso vai além das paredes do Hub, alcançando comunidades
                e gerando oportunidades reais.
              </p>
              ...
              <div className="p-10 bg-gray-50 border border-gray-100 rounded-[40px] relative group hover:bg-brand-teal/[0.02] transition-colors">
                ...
                <p className="text-gray-600 font-medium leading-relaxed ">
                  Nosso principal braço social. O Amontada Valley é um
                  ecossistema de inovação social focado em transformar o
                  interior do Ceará através da educação tecnológica,
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-24">
            <h2 className="text-5xl md:text-7xl font-black mb-6 uppercase tracking-wide text-white ">
              TIME{" "}
              <span className="text-[#0ae2b1] underline decoration-white/20">
                NINNA
              </span>
            </h2>
            <p className="text-white/60 max-w-2xl mx-auto font-barlow text-lg  uppercase tracking-widest">
              Gente que acredita e faz acontecer.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-12">
            {loadingEquipe
              ? Array.from({ length: 4 }).map((_, i) => (
                  <div
                    key={i}
                    className="bg-white/[0.03] h-96 w-full animate-pulse border border-white/10 rounded-[40px]"
                  />
                ))
                  ...
                  >
                    <div className="relative aspect-[4/5] rounded-[40px] overflow-hidden border border-white/10 bg-white/[0.03] backdrop-blur-md transition-all duration-700 group-hover:translate-y-[-10px] shadow-xl hover:shadow-2xl">
                      <img
                        src={
                          member.foto ||
                          "https://picsum.photos/seed/profile/400/500"
                        }
                        alt={member.nome}
