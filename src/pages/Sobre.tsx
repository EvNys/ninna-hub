            ...
            >
              ...
              <div className="space-y-4 text-white/75 text-lg leading-relaxed font-barlow">
                <p className="border-l-2 border-[#0ae2b1] pl-8">
                  O Núcleo de Inovação e Novos Negócios Aplicados, <strong>NINNA Hub</strong> é um hub de inovação que conecta empresas, startups, investidores e instituições estratégicas para impulsionar a transformação dos negócios por meio da inovação aberta, da tecnologia e do empreendedorismo.
                </p>
