          ...
          <div className="bg-white/[0.03] backdrop-blur-md p-12 md:p-24 relative overflow-hidden border border-white/10 shadow-2xl rounded-[60px]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
              <div>
                ...
                <button className="bg-[#0ae2b1] text-black hover:bg-[#0ae2b1]/90 px-8 py-4 rounded-xl font-black text-[10px] uppercase tracking-widest flex items-center group shadow-lg shadow-[#0ae2b1]/20 transition-all cursor-pointer">
                  Agendar Visita <ArrowRight className="ml-3 w-5 h-5 group-hover:translate-x-2 transition-transform" />
                </button>
              </div>
